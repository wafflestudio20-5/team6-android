...
class FolloweeListAdapter(private val onItemClicked: (FolloweeDTO) -> Unit) : PagingDataAdapter<FolloweeDTO, FolloweeListAdapter.FolloweeViewHolder>(DiffCallback) {
